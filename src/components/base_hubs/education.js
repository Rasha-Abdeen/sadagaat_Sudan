...
class Education extends Component {
  ...
  render() {
    ...
    console.log("the formated data from api-----------=",details)
    ...
    return (
      <React.Fragment>
           ...
           <div className="section-content">
             <div className="row" >
               <div className="col-md-12 text-center">
                 <h3 className="font-28 text-white">{t("Education")} </h3>
               </div>
             </div>
           </div>
         </div>
       ...
       :
       <section className="education-bg-img inner-header divider parallax layer-overlay overlay-dark-6">
         <div className="container pt-60 pb-60 "
       >
           <div className="section-content">
             <div className="row" >
